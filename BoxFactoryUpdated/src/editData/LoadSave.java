...
public class LoadSave
{
	...
	public static Game loadSave(String gameSelection, ArrayList<Window> windows, ArrayList<Upgrade> upgrades, ArrayList<Item> items, ArrayList<Food> foods, ArrayList<Junk> junk) throws IOException
	{
		...
		if (gameSelection.substring(0,1).equals("n"))
		{
			...
			factoryName = Intro.getFactoryName(); bufferedReader.readLine();
			characterName = Intro.getCharacterName(); bufferedReader.readLine();
		...
		game = new Game(factory, character, gameSelection, windows);
