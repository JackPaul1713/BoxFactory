...
public class LoadData
{
	...
	public static ArrayList<Window> initializeWindows()
	{
		...
		String[] statsOptions = new String[] {"Factory Stats", "Character Stats"};
		Menu stats = new Menu("[][][][][][][][][][][] Display Stats  [][][][][][][][][][][]", statsOptions, 17);
